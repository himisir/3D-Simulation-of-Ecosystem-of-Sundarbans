...
    float camSens = 10f; //How sensitive it with mouse
...
    private float totalRun = 1.0f;
    ...
    public void SetBooleans(bool _isSimulationOn)
    {
    ...
    void Update()
    {
        if (isSimulationOn)
        {
            ...
            { // only move while a direction key is pressed
                ...
                p = p * Time.deltaTime; Vector3 newPosition = transform.position;
                ...
                pos.y = Mathf.Clamp(pos.y, 10, 1000);
